...
const WarningWrapper = ({ needsLockWarning, hashtagWarning, directMessageWarning }) => {
  ...
  if (directMessageWarning) {
    const message = (
      <span>
        <FormattedMessage id='compose_form.encryption_warning' defaultMessage='Posts on CollabSphere are not end-to-end encrypted. Do not share any dangerous information over CollabSphere.' /> <a href='/terms' target='_blank'><FormattedMessage id='compose_form.direct_message_warning_learn_more' defaultMessage='Learn more' /></a>
      </span>
    );
